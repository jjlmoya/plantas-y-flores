...
function formatTaskName(task) {
  const translations = {
    ...
    'mood_enhancement': 'Mejora del Estado de Ánimo',
    ...
    'sweet_creamy_raspberry_hint': 'Dulce Cremoso con Toque de Frambuesa',
    'clove_spicy': 'Picante a Clavo',
    'spicy_medicinal': 'Picante Medicinal',
    'spicy_clove': 'Picante a Clavo',
    'sweet_licorice': 'Dulce a Regaliz',
